...
class UserSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # Removes plain text password, later we'll add password back as a hash
        password = data.get('password')
        # We won't re-add this field as it's not on the model
        """ Patchwork to allow the upadting of user """
        try:
...
# This serializer customises the payload contained within the JWT generated by SimpleJWT
