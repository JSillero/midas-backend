...
from os import getenv  # This allows us to access environment variables
from dotenv import load_dotenv  # This loads our custom environment variables
...
# path format is: appname.ModelName
